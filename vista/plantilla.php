...
-->
<?php
  include_once "principal/plantilla_header-nav.php";
?>
<!-- *************** -->
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                          ...
                          <li class="list-group-item">
                            ...
                            <span id="us_tipo" class="float-right">xxxxx</span>
                          </li>
                    ...
                    <div class="card card-success">
                      ...
                      <div class="card-body">
                        ...
                        <strong style="color: #0b7300"> <i class="fas fa-map-marker-alt mr-1"></i>Residencia </strong>
                        <p id="residencia_us" class="text-muted">xxxxx</p>
                        <strong style="color: #0b7300"> <i class="fas fa-at mr-1"></i>Correo </strong>
                        <p id="correo_us" class="text-muted">xxxxx</p>
                      ...
                      <div class="card-footer">
                        <p class="text-muted">click ayuda</p>
                      </div>
                    </div>
...
-->
<?php
  include_once "principal/plantilla_footer.php";
?>
<!-- *************** -->