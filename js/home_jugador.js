...
$(document).ready(function () {
  ...
  mostrar_proxima_reserva_jugador();
  function mostrar_proxima_reserva_jugador() {
    console.log("muestro proxima reserva del Jugador");
    let funcion = "mostrarProximaReserva";
    $.post("../controlador/ReservaController.php", { funcion }, (response) => {
      console.log(response);
      let reservas = JSON.parse(response);
      let id_reserva = reservas[0].id_reserva;
      let fecha = reservas[0].fecha;
      let hora = reservas[0].hora;
      let pista = reservas[0].pista;
      document.getElementById("miProximaReserva_reserva").innerHTML = " " + id_reserva;
      document.getElementById("miProximaReserva_fecha").innerHTML = fecha + " ";
      document.getElementById("miProximaReserva_hora").innerHTML = " " + hora + " ";
      document.getElementById("miProximaReserva_pista").innerHTML = " " + pista;

      let i = 1;
      reservas.forEach((reserva) => {
        console.log(reserva.usuario);
        console.log(reserva.avatar);
        console.log(reserva.nombre_apellidos);
        console.log(reserva.nombre_nivel);
        console.log(reserva.telefono);
        document.getElementById(`miProximaReserva_usuario${i}`).innerHTML = reserva.usuario;

        document.getElementById(`miProximaReserva_avatar${i}`).src = "../img/" + reserva.avatar;

        document.getElementById(`miProximaReserva_nombre${i}`).innerHTML = reserva.nombre_apellidos;
        document.getElementById(`miProximaReserva_nivel${i}`).innerHTML = reserva.nombre_nivel;
        document.getElementById(`miProximaReserva_tel${i}`).innerHTML = reserva.telefono;
        i++;
      });
    });
  }
  ...
  let funcion = "listar_reservas_jugador";
  let datatable = $("#tabla_reservas_jugador").DataTable({
    ajax: {
  ...
  $("#tabla_reservas_jugador tbody").on("click", ".ver", function () {
    console.log("entra");
  ...
  $("#tabla_reservas_jugador tbody").on("click", ".borrar", function () {
    console.log("entra");
    let datos = datatable.row($(this).parents()).data();
    console.log(datos);
